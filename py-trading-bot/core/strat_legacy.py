...
class StratPatternLight(UnderlyingStrat):  
    '''
...
class StratPatternLightMatrendBbands(UnderlyingStrat):  
    '''
...
class StratPatternLightSuperBbands(UnderlyingStrat):  
    '''
    strat_pattern_light for bear and uncertain trends
...
class StratCarefulSuperBbands(UnderlyingStrat):  
    '''
    Strat_pattern_light for bear and uncertain trends
    MA+Supertrend for bull
...
class StratPatternLightMatrendMacdbb(UnderlyingStrat):  
    '''
...
class StratPatternLightSuperMacdbb(UnderlyingStrat):  
    '''
    As strat_pattern_light_matrend_bbands but with different trend calculation 
    '''
    def __init__(self,
...
class StratPatternLightMacro(UnderlyingStrat):  
    '''
